...
// This file is an ECMAScript Module (https://nodejs.org/api/esm.html) because it needs to be able to import the repositories
...
Promise
    ...
    .then(responses => {
        ...
        const fileContents = `// generated by lib/dependency-graph/index.mjs on ${time}\n\nconst nodes = ${JSON.stringify(graphData, null, '  ')}\n\nexport default nodes\n`
        fs.writeFileSync(`${destinationPath}/../../data/node-data.mjs`, fileContents)
    })
    .catch(err => {
        console.log(err)
    })
